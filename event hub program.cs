...
namespace SendSampleData
{
    class Program
    {
        ...
        const string connectionString = @"Endpoint=sb://lrmtdemo.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=P5kxQmRSD17yHA56/DlDj30DXHgRSE2gqsH9dX7clKU=;EntityPath=testehub";
